...
<!-- for pinned version -->
<?php echo app('Illuminate\Foundation\Vite')('resources/js/app.js'); ?>  <!-- Esto se encargará de incluir el archivo con el nombre hashado -->
...
<body class="<?php echo $__env->yieldContent('classes_body'); ?>" <?php echo $__env->yieldContent('body_data'); ?> style="background-color: #13f6a8">
...
<?php /**PATH C:\laragon\www\sistema_cursos2\resources\views/vendor/adminlte/master.blade.php ENDPATH**/ ?>